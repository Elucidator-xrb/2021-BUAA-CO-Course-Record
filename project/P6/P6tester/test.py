...
mars_dir = 'D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\Mars_perfect.jar'

#修改2：将要自动生成的十六进制代码的存放位置
# hexcode_dir = 'C:\\Users\\Dr.H\\Desktop\\Project5\\code.txt'
hexcode_dir = 'D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\code.txt'
...
standard_outdir = 'D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\ans_out_mars.txt'

#修改4：analysis文件夹和包含有带.asm后缀的MIPS源代码的位置
# walk = os.walk('C:\\Users\\Dr.H\\Desktop\\analysis\\work\\P5_LX_github')
walk = os.walk('D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\P6tester\\analysis\\work\\P6_wzk')
...
for path1, docu_list, file_list in walk:
    for file_name in file_list:
        if('.asm' in file_name):
            ...
            prj_dir = 'D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\P6_L1_CPU\\mips_tb2_beh.prj'
            # tcl_dir = 'D:\\ISE_codes\\p5_version2\\conf.tcl'
            tcl_dir = 'D:\\0_Personal_File\\Grade2_01_Autumn\\CO\\P6\\P6_L1_CPU\\conf.tcl'
            ...
            os.system(fuse_dir + ' -nodebug -prj ' + prj_dir + ' -o testX.exe mips_tb2 > log.txt')
